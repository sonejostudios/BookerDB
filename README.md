...
* Monitor Filter COMING, PLAYED, WAITING, CANCELLED, CONTACT, City, Country, Venue, Artist, Contacts, Prints, etc...
* Statistics
* Notes
...
2. from this folder start BookerDB with: python3 BookerDB.py
